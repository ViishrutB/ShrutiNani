...
| M5 | Publications page | All 4 papers linking to journal/DOI + thesis with embedded PDF viewer, formatted citations | ✅ All 4 papers link to their DOI, thesis hosted with an embedded viewer + download, author-position filter/pills |
